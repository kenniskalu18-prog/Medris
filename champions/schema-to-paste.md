# Mobihealth Champions — Supabase Setup SQL

Copy everything inside the code block below and paste it into your new Supabase project's SQL Editor (SQL Editor -> New query -> paste -> Run).
