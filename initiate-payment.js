...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const subaccount = orderRow?.vendor?.paystack_subaccount_code;
    ...
    const initRes = await fetch("https://api.paystack.co/transaction/initialize", {
      ...
      body: JSON.stringify({
        ...
        // No subaccount yet = vendor hasn't set up payouts; the full amount
        // goes to the platform account until they do (nothing gets stuck).
